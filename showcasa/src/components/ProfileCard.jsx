...
const ProfileCard = ({ profile }) => {
  return (
    <div className="profile-card flex flex-col rounded-3xl border border-[#DAD8DD] group">
      ...
      <div className="content-wrapper p-5 bg-white rounded-b-3xl overflow-hidden group-hover:bg-[#F3F0FF] duration-300 ease-in-out group-hover:cursor-pointer">
        <h6 className="font-literata-bold text[#211F24] mb-2">{profile.name}</h6>
        ...
        <Link to={`/profile/${profile.id}`} className="btn btn-secondary">
