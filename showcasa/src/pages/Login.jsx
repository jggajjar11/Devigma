  ...
  return (
    <div className="login-wrapper flex items-center">
      <div className="lg:w-1/2 hidden lg:block self-start">
        <img src={loginImg} alt="showcasa login" width={960} height={1024} />
      </div>
      <div className="w-full lg:w-1/2">
      <div className="w-full lg:max-w-[625px] pt-[30px] px-4 lg:p-0 mx-auto text-center bg-[#E9E8EB] lg:bg-transparent">
        <h1 className="h3 font-literata-bold text-[#703cd2] mb-2">Showcase Your Talent.<br></br>Get Discovered.</h1>
        <p className="text-[#646167]">Log in to connect, share your work, and explore amazing talent.</p>
        <div className="form-wrapper max-w-[360px] mx-auto pt-[40px]">
          ...
          <div className="dividerwrapper py-[30px] relative before:content-[''] before:absolute before:top-1/2 before:left-0 before:w-full before:h-px before:bg-[#646167] lg:before:bg-[#E2E0E4]">
            <p className="text-[#646167] px-3 bg-[#E9E8EB] lg:bg-white w-auto inline-block relative z-[1]">or</p>
          </div>
          <div className="social-wrapper flex flex-col items-center justify-center gap-4 mb-6">
            <button className="btn bg-transparent border border-[#E2E0E4] !flex gap-3 items-center lg:min-w-[360px] h-[60px]">
              ...
              <Link to="https://accounts.google.com/" className="relative z-[1] font-inter text-[#646167] text-md">Continue with Google</Link>
            </button>
            <button className="btn bg-transparent border border-[#E2E0E4] !flex gap-3 items-center lg:min-w-[360px] h-[60px]">
            <img src={linkedinIcon} alt="linkedin-icon" />
              <Link to="https://www.linkedin.com/login" className="relative z-[1] font-inter text-[#646167] text-md">Continue with Facebook</Link>
            </button>
          </div>
          <p className="text-[#646167]">New here? <Link className="text-[#703CD2] underline hover:text-[#371A6C]" to="/signup">Create an account</Link><br></br>and start showcasing your work!</p>
        </div>
      </div>
      </div>
    </div>
